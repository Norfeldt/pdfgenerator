...
\newcommand{\headerimage}{\includesvg[height=1cm]{$header-image$}}

% Header
%\fancyhead[L]{\textbf{Your Company Name}} % L means it goes tot left of page
...
\setlength{\footskip}{20pt} % Adjust the footer height from the end of the page
...
\fancyfoot[C]{
    ...
    \begin{minipage}[t]{0.25\textwidth}
        \raggedright
        \textbf{Information Owner: Author} \\
        Date: \today
    \end{minipage}
    \hfill
...
\newcommand{\heavycolor}{\arrayrulecolor{gray}} % Heavy rules (e.g., \toprule) in black
\newcommand{\midrulecolor}{\arrayrulecolor{black}} % Midrule in red
\newcommand{\bottomrulecolor}{\arrayrulecolor{black}} % \bottomrule in red
\newcommand{\toprulecolor}{\arrayrulecolor{white}} % \toprule in blue

% Redefine \midrule to apply the color
\let\oldmidrule\midrule
\renewcommand{\midrule}{\midrulecolor\oldmidrule\heavycolor}

% Redefine \toprule to use blue
\let\oldtoprule\toprule
\renewcommand{\toprule}{\toprulecolor\oldtoprule\arrayrulecolor{white}} % Reset to black after \toprule

% Redefine \bottomrule to use red
\let\oldbottomrule\bottomrule
\renewcommand{\bottomrule}{\bottomrulecolor\oldbottomrule\arrayrulecolor{black}} % Reset to black after \bottomrule
...
\lstset{
  ...
  basicstyle=\fontspec{Inconsolata},
%  basicstyle=\fontspec{Courier New},
